...
CD_APPLET_ON_CLICK_BEGIN
	...
	{
		Icon *pIcon = cairo_dock_get_dialogless_icon_full (myContainer);
		...
		cairo_dock_show_dialog_with_question (cQuestion, pIcon, myContainer, MY_APPLET_SHARE_DATA_DIR"/"MY_APPLET_ICON_FILE, (CairoDockActionOnAnswerFunc) cairo_dock_open_module_config_on_demand, myApplet, NULL);
		g_free (cQuestion);
	}
