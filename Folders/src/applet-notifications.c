...
CD_APPLET_ON_BUILD_MENU_BEGIN
	...
	{
		if (CD_APPLET_CLICKED_ICON == myIcon)  // clic sur un des fichiers
		{
		...
		{
			GtkWidget *pSubMenu = CD_APPLET_CREATE_MY_SUB_MENU ();
				CD_APPLET_ADD_IN_MENU_WITH_STOCK_AND_DATA (D_("Rename this file"), GTK_STOCK_EDIT, _cd_folders_rename_file, pSubMenu, data);
				CD_APPLET_ADD_IN_MENU_WITH_STOCK_AND_DATA (D_("Delete this file"), GTK_STOCK_REMOVE, _cd_folders_delete_file, pSubMenu, data);
