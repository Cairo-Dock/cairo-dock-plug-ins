...
printf("myData.switcher.MaxWidthIcon : %d \n",myData.switcher.MaxWidthIcon);
printf("myData.switcher.MaxNbLigne : %d \n",myData.switcher.MaxNbLigne);
myData.switcher.scale =gdk_pixbuf_scale_simple(myData.switcher.icon,
    myData.switcher.MaxWidthIcon, myData.switcher.MaxNbLigne,
     GDK_INTERP_BILINEAR);

//cairo_surface_t *surface;
//cairo_t *cr;

//surface = cairo_image_surface_create (CAIRO_FORMAT_ARGB32, fMaxScale, fMaxScale);
//cr = cairo_create (surface);
//gdk_cairo_set_source_pixbuf(pIconContext,myData.switcher.icon,0, 0);
...
//onContext);
cairo_move_to (pIconContext,0,0);
gdk_cairo_set_source_pixbuf(pIconContext,myData.switcher.scale,0, 0);
cairo_paint_with_alpha (pIconContext, 1.);
//cairo_restore (pIconContext);
...
cairo_rectangle(pIconContext, myData.switcher.MaxWidthIcon*i, 0,myData.switcher.MaxWidthIcon , myData.switcher.MaxNbLigne);
				...
				cairo_stroke_preserve(pIconContext);
//cairo_move_to (pIconContext, myData.switcher.MaxWidthIcon*i, 0);
gdk_cairo_set_source_pixbuf(pIconContext,myData.switcher.scale,myData.switcher.MaxWidthIcon*i, 0);
cairo_paint_with_alpha (pIconContext, 1.);
				cairo_set_source_rgba(pIconContext,myConfig.RGBIndColors[0],myConfig.RGBIndColors[1],myConfig.RGBIndColors[2],myConfig.RGBIndColors[3]);
 				cairo_fill(pIconContext);
	cairo_restore(pIconContext);
...
gdk_cairo_set_source_pixbuf(pIconContext,myData.switcher.scale,0, myData.switcher.MaxNbLigne);
cairo_paint_with_alpha (pIconContext, 1.);
					cairo_set_source_rgba(pIconContext,myConfig.RGBIndColors[0],myConfig.RGBIndColors[1],myConfig.RGBIndColors[2],myConfig.RGBIndColors[3]);
 					cairo_fill(pIconContext);
					cairo_restore (pIconContext);
...
gdk_cairo_set_source_pixbuf(pIconContext,myData.switcher.scale,myData.switcher.MaxWidthIcon*(i-myData.switcher.NumDeskbyLigne), myData.switcher.MaxNbLigne);
cairo_paint_with_alpha (pIconContext, 1.);
					cairo_set_source_rgba(pIconContext,myConfig.RGBIndColors[0],myConfig.RGBIndColors[1],myConfig.RGBIndColors[2],myConfig.RGBIndColors[3]);
 					cairo_fill(pIconContext);
					cairo_restore (pIconContext);
...
//switcher_draw_main_dock_icon (pSurfacenew);
CD_APPLET_REDRAW_MY_ICON
cd_message ("dessiner");
