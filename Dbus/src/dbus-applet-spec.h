...
/* BOOLEAN:BOXED,POINTER (/tmp/dbus-binding-tool-c-marshallers.Y1M9YU:1) */
...
/* BOOLEAN:STRING,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.Y1M9YU:2) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.Y1M9YU:3) */
...
static const DBusGMethodInfo dbus_glib_cd_dbus_applet_methods[] = {
  ...
  { (GCallback) cd_dbus_applet_add_sub_icons, dbus_glib_marshal_cd_dbus_applet_BOOLEAN__BOXED_POINTER, 371 },
};
