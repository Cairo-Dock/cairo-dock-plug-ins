...
static const DBusGMethodInfo dbus_glib_cd_dbus_applet_methods[] = {
  ...
  { (GCallback) cd_dbus_applet_popup_dialog, dbus_glib_marshal_cd_dbus_applet_BOOLEAN__BOXED_BOXED_POINTER, 809 },
  { (GCallback) cd_dbus_applet_add_data_renderer, dbus_glib_marshal_cd_dbus_applet_BOOLEAN__STRING_INT_STRING_POINTER, 907 },
