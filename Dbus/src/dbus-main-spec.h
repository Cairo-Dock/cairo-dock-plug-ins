...
/* BOOLEAN:STRING,INT,STRING,STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:1) */
...
/* BOOLEAN:STRING,BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:2) */
...
/* BOOLEAN:STRING,STRING,STRING,STRING,INT,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:3) */
extern void dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_STRING_STRING_STRING_INT_STRING_POINTER (GClosure     *closure,
                                                                                                    ...
                                                                                                    gpointer      marshal_data);
void
dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_STRING_STRING_STRING_INT_STRING_POINTER (GClosure     *closure,
                                                                                        GValue       *return_value G_GNUC_UNUSED,
                                                                                        guint         n_param_values,
                                                                                        const GValue *param_values,
                                                                                        gpointer      invocation_hint G_GNUC_UNUSED,
                                                                                        gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_STRING_STRING_STRING_INT_STRING_POINTER) (gpointer     data1,
                                                                                            gpointer     arg_1,
                                                                                            gpointer     arg_2,
                                                                                            gpointer     arg_3,
                                                                                            gpointer     arg_4,
                                                                                            ...
                                                                                            gpointer     arg_7,
                                                                                            gpointer     data2);
  register GMarshalFunc_BOOLEAN__STRING_STRING_STRING_STRING_INT_STRING_POINTER callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
  ...
  callback = (GMarshalFunc_BOOLEAN__STRING_STRING_STRING_STRING_INT_STRING_POINTER) (marshal_data ? marshal_data : cc->callback);
...
/* BOOLEAN:POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:4) */
...
/* BOOLEAN:BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:5) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:6) */
...
/* BOOLEAN:STRING,STRING,STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.SDNU2U:7) */
