...
/* BOOLEAN:STRING,INT,STRING,STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:1) */
...
/* BOOLEAN:STRING,BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:2) */
...
/* BOOLEAN:STRING,STRING,STRING,INT,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:3) */
extern void dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER (GClosure     *closure,
                                                                                             GValue       *return_value,
                                                                                             guint         n_param_values,
                                                                                             const GValue *param_values,
                                                                                             gpointer      invocation_hint,
                                                                                             gpointer      marshal_data);
void
dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER (GClosure     *closure,
                                                                                 GValue       *return_value G_GNUC_UNUSED,
                                                                                 guint         n_param_values,
                                                                                 const GValue *param_values,
                                                                                 gpointer      invocation_hint G_GNUC_UNUSED,
                                                                                 gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER) (gpointer     data1,
                                                                                     gpointer     arg_1,
                                                                                     gpointer     arg_2,
                                                                                     gpointer     arg_3,
                                                                                     gint         arg_4,
                                                                                     ...
                                                                                     gpointer     arg_6,
                                                                                     gpointer     data2);
  register GMarshalFunc_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
  ...
  callback = (GMarshalFunc_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER) (marshal_data ? marshal_data : cc->callback);
...
/* BOOLEAN:POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:4) */
...
/* BOOLEAN:BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:5) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:6) */
...
/* BOOLEAN:STRING,STRING,STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.0X4P0U:7) */
...
static const DBusGMethodInfo dbus_glib_cd_dbus_main_methods[] = {
  ...
  { (GCallback) cd_dbus_main_register_new_module, dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_STRING_STRING_INT_STRING_POINTER, 1099 },
  { (GCallback) cd_dbus_main_unregister_module, dbus_glib_marshal_cd_dbus_main_BOOLEAN__STRING_POINTER, 1221 },
};
