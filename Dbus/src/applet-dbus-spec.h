...
/* BOOLEAN:BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.JWRUMU:1) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.JWRUMU:2) */
...
/* BOOLEAN:POINTER (/tmp/dbus-binding-tool-c-marshallers.JWRUMU:3) */
