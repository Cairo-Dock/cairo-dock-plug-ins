...
/* BOOLEAN:BOOLEAN,POINTER (/tmp/dbus-binding-tool-c-marshallers.T1WWOU:1) */
...
/* BOOLEAN:STRING,STRING,STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.T1WWOU:2) */
...
/* BOOLEAN:STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.T1WWOU:3) */
...
/* BOOLEAN:POINTER (/tmp/dbus-binding-tool-c-marshallers.T1WWOU:4) */
...
static const DBusGMethodInfo dbus_glib_cd_dbus_callback_methods[] = {
  ...
  { (GCallback) cd_dbus_callback_show_dock, dbus_glib_marshal_cd_dbus_callback_BOOLEAN__BOOLEAN_POINTER, 228 },
  { (GCallback) cd_dbus_callback_load_launcher_from_file, dbus_glib_marshal_cd_dbus_callback_BOOLEAN__STRING_POINTER, 273 },
  { (GCallback) cd_dbus_callback_create_launcher_from_scratch, dbus_glib_marshal_cd_dbus_callback_BOOLEAN__STRING_STRING_STRING_STRING_POINTER, 338 },
  { (GCallback) cd_dbus_callback_set_quick_info, dbus_glib_marshal_cd_dbus_callback_BOOLEAN__STRING_STRING_STRING_STRING_POINTER, 449 },
  { (GCallback) cd_dbus_callback_set_label, dbus_glib_marshal_cd_dbus_callback_BOOLEAN__STRING_STRING_STRING_STRING_POINTER, 551 },
};
