...
CD_APPLET_DEFINITION (N_("Sync-Menu"),
	3, 0, 99,
	CAIRO_DOCK_CATEGORY_APPLET_INTERNET,
	N_("This applet collects status information data from processes\n"
...
CD_APPLET_INIT_BEGIN
	...
	myData.pIndicator = cd_indicator3_load (myConfig.cIndicatorName,
		cd_sync_entry_added,
		cd_sync_entry_removed,
		cd_sync_accessible_desc_update,
		NULL, // menu show
		myApplet);
...
CD_APPLET_STOP_BEGIN
	...
	cd_sync_destroy (myData.pIndicator, myData.pEntry, myApplet); // remove the connection to signals (menu)
...
CD_APPLET_RELOAD_BEGIN
	...
	{
		// CD_APPLET_SET_DEFAULT_IMAGE_ON_MY_ICON_IF_NONE;  // set the default icon if none is specified in conf.
		cd_sync_reload (myData.pIndicator, myData.pEntry, myApplet);
	}
