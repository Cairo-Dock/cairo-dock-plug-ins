...
CD_APPLET_INIT_BEGIN
	...
	cd_me_connect_to_service (myApplet);
	
	myData.iSidGetMenuOnce = g_idle_add ((GSourceFunc)_get_menu_once, myApplet);
...
CD_APPLET_STOP_BEGIN
	...
	cd_me_disconnect_from_service (myApplet);
	
	if (myData.iSidGetMenuOnce != 0)
		g_source_remove (myData.iSidGetMenuOnce);
