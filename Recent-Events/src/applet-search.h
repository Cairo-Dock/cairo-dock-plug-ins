...
void cd_find_recent_events (int iSortType, CDOnGetEventsFunc pCallback, gpointer data);


void cd_search_events (const gchar *cQuery, CDOnGetEventsFunc pCallback, gpointer data);
