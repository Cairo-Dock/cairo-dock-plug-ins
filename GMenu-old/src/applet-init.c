...
static gboolean _cd_gmenu_end_update (GldiModuleInstance *myApplet)
{
...
static void _cd_gmenu_load_images (GldiModuleInstance *myApplet)
{
...
static gboolean _cd_gmenu_create_main_menu_end (GldiModuleInstance *myApplet)
{
...
static void _cd_gmenu_create_main_menu_async (GldiModuleInstance *myApplet)
{
