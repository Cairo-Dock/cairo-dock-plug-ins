...
#define _cd_mouse_register_on_dock(...) do {\
	...
	cairo_dock_register_notification (CAIRO_DOCK_RENDER_DOCK, (CairoDockNotificationFunc) cd_show_mouse_render, CAIRO_DOCK_RUN_AFTER, NULL); } while (0)

#define _cd_mouse_register_on_desklet(...) do {\
	...
	cairo_dock_register_notification (CAIRO_DOCK_RENDER_DESKLET, (CairoDockNotificationFunc) cd_show_mouse_render, CAIRO_DOCK_RUN_AFTER, NULL); } while (0)

#define _cd_mouse_unregister_from_dock(...) do {\
	...
	cairo_dock_remove_notification_func (CAIRO_DOCK_ENTER_DOCK, (CairoDockNotificationFunc) cd_show_mouse_enter_container, NULL); } while (0)

#define _cd_mouse_unregister_from_desklet(...) do {\
	...
	cairo_dock_remove_notification_func (CAIRO_DOCK_ENTER_DESKLET, (CairoDockNotificationFunc) cd_show_mouse_enter_container, NULL); } while (0)
...
CD_APPLET_RELOAD_BEGIN
	...
	{
		if (myConfig.iContainerType ^ myData.iContainerType != 0)
		{
