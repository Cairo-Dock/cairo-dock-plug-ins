...
CD_APPLET_DEFINITION (N_("Printers-Menu"),
	3, 0, 99,
	CAIRO_DOCK_CATEGORY_APPLET_DESKTOP,
	N_("This applet is designed to let you view and control active print jobs.\n"
...
CD_APPLET_INIT_BEGIN
	...
	myData.pIndicator = cd_indicator3_load (myConfig.cIndicatorName,
		cd_printers_entry_added,
		cd_printers_entry_removed,
...
CD_APPLET_STOP_BEGIN
	...
	cd_printers_destroy (myData.pIndicator, myData.pEntry, myApplet); // remove the connection to signals (menu)
